...
function ApplicationsPage({ theme, toggleTheme, sidebarActive, setSidebarActive, isLoading, setIsLoading, error, setError}) {
  ...
  useEffect(() => {
    ...
    fetchData('https://api.tareqitos.me/api/applications');
  }, []);
          ...
          <div className={styles['main-wrapper']}>
            <div className={styles['main-content']}>
              <div className={styles.resources}>
                <Title title='Japanese Applications 💻' description='Discover amazing software and applications to boost your Japanese learning journey!' />
                <Searchbar
                  links={links}
