    ...
    return (
        <header className={styles['header']}>
            ...
            <div className={styles['header-right-side']}>
                ...
                <button onClick={() => handleToggleTheme()} className={components_styles['theme-toggle']}> { theme == 'dark' ? <MoonIcon className={components_styles['h-icon']} /> : <SunIcon className={components_styles['h-icon']} />}</button>
                <hr className={styles['hr']} />
