...
export default function BeginnersPage() {
    ...
    return (
        <div className="flex flex-row gap-8 ">
            ...
            <div className="flex flex-col mt-10 lg:mt-20 border-0">
                <h1 className="text-4xl font-bold">Beginner Essentials</h1>
                ...
                <div className="flex flex-col mt-10 mb-20">
                    ...
                    <div className="md:column">
                        <h1 className="font-semibold text-2xl">Grammar</h1>
                        <ResourceCard array={grammar} className="mt-2 !gap-2" />
                        <h1 className="font-semibold text-2xl">Anki Cards</h1>
