...
const buttonStyles = {
    ...
    button: "text-card-background hover:text-primary font-bold bg-primary hover:bg-card-background py-2 px-4 rounded-full border-2 border-primary transition-primary cursor-pointer",
